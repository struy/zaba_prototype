    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.CharField(choices=[('ft', 'full-time'), ('pt', 'part-time'), ('ca', 'casual')], default='ft', max_length=2)),
                ('countries', django_countries.fields.CountryField(default='EN', help_text='What language does the employer speak?', max_length=11, multiple=True, verbose_name='language')),
                ('image', sorl.thumbnail.fields.ImageField(blank=True, null=True, upload_to=apps.adverts.models.user_directory_path, verbose_name='Logo or image')),
                ...
                ('favourites', models.ManyToManyField(blank=True, default=None, related_name='favourite_jobs', to=settings.AUTH_USER_MODEL)),
                ('jobtype', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jobs.JobType', verbose_name='job type')),
            ],
            options={
                'ordering': ['modified'],
                'abstract': False,
